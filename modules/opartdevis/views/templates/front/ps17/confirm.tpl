...
{block name="page_content"}
    ...
    <p>
        <a href="{$link->getModuleLink('opartdevis', 'ShowQuotation', ['id_cart' => $id_cart])|escape:'htmlall':'UTF-8'}" class="btn-default button button-medium">
            <span>
    ...
    <ul class="footer_links clearfix">
        <li>
            <a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" class="btn-default button button-small">
                <span><i class="icon-chevron-left"></i> {l s='Back to Your Account' mod='opartdevis'}</span>
            </a>
        </li>
        <li class="f_right">
            <a href="{$base_dir|escape:'htmlall':'UTF-8'}" class="btn-default button button-small">
