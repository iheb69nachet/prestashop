            ...
            {if $customer_id == 0}
                ...
                <div class="form-group">
                    <div class="col-lg-3">
                        ...
                        <input class="form-control" type="text" name="customer_firstname" value="{if isset($smarty.post.customer_firstname)}{$smarty.post.customer_firstname nofilter}{/if}" id="customer_firstname" />
                    </div>
                    <div class="col-lg-3">
                        <label for="customer_lastname" class="control-label">{l s='Lastname' mod='opartdevis'}*</label>
                        <input class="form-control" type="text" name="customer_lastname" value="{if isset($smarty.post.customer_lastname)}{$smarty.post.customer_lastname nofilter}{/if}" id="customer_lastname" />
                    </div>
                    <div class="col-lg-3">
                        <label for="customer_email" class="control-label">{l s='Email' mod='opartdevis'}*</label>
                        <input class="form-control" type="text" name="customer_email" value="{if isset($smarty.post.customer_email)}{$smarty.post.customer_email nofilter}{/if}" id="customer_email" />
                    </div>
                    <div class="col-lg-3">
                        <label for="customer_phone" class="control-label">{l s='Phone' mod='opartdevis'}</label>
                        <input class="form-control" type="text" name="customer_phone" value="{if isset($smarty.post.customer_phone)}{$smarty.post.customer_phone nofilter}{/if}" id="customer_phone" />
                    </div>
                </div>
                <!-- /Customer -->
            {/if}
            ...
            {else}
                <div class="form-group">
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control" id="delivery_address_text" name="delivery_address_text">{if isset($smarty.post.delivery_address_text)}{$smarty.post.delivery_address_text nofilter}{/if}</textarea>
                    </div>
                    <div class="col-lg-6">
                        <label for="invoice_address_text" class="control-label">{l s='Invoice addresse' mod='opartdevis'}</label>
                        <textarea class="form-control" id="invoice_address_text" name="invoice_address_text">{if isset($smarty.post.invoice_address_text)}{$smarty.post.invoice_address_text nofilter}{/if}</textarea>
                    </div>
                </div>                        
            {/if}
            <!-- /addresses -->
