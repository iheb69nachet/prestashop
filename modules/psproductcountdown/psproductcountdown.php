...
class PSProductCountdown extends Module
{
    ...
    public function install()
    {
        ...
        if ($this->getPSVersion() <= 1.6) {
            ...
            if (!$this->registerHook('displayPSProductCountdown')) {
                return false;
            }
        }
    ...
    {
        return $this->hookPSProductCountdown($params);
    }
    ...
    {
        $this->html = '';
        $this->html .= '<a class="prestasite-logo" target="_blank" href="http://presta.site/">';
        $this->html .= '<img src="' . $this->_path . 'views/img/logops.png"/>';
        $this->html .= '<span class="devby">' . $this->l('Developed by:') . '</span></a>';
        $this->html .= $this->postProcess();
        $this->html .= $this->renderForm();
        $this->html .= $this->renderCountdownsList();
        $this->html .= $this->renderAdditionalInstructions();
        $this->html .= $this->renderSupport();
