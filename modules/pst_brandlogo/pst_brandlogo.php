...
class Pst_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'pst_brandlogo';
        ...
        $this->templateFile = 'module:pst_brandlogo/views/templates/hook/pst_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('PST_BRAND_SLIDER', 1);
        Configuration::updateValue('PST_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('PST_BRAND_SLIDER')
            && Configuration::deleteByName('PST_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitPstBlockBrandLogos')) {
            
			Configuration::updateValue('PST_BRAND_SLIDER', (int)(Tools::getValue('PST_BRAND_SLIDER')));
			Configuration::updateValue('PST_BRAND_NAME', (int)(Tools::getValue('PST_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitPstBlockBrandLogos';
    ...
    {
        return array(
            'PST_BRAND_SLIDER' => (int)Tools::getValue('PST_BRAND_SLIDER', Configuration::get('PST_BRAND_SLIDER')),
            'PST_BRAND_NAME' => (int)Tools::getValue('PST_BRAND_NAME', Configuration::get('PST_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('PST_BRAND_SLIDER'),
			'brandname' => Configuration::get('PST_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('pst_brandlogo');
