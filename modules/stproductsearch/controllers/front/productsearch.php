...
if (file_exists(_PS_MODULE_DIR_.'stproductsearch/classes/STSearchProductSearchProvider.php')) {
    require_once( _PS_MODULE_DIR_.'stproductsearch/classes/STSearchProductSearchProvider.php' );
}
...
// use STSearch\STSearchProductSearchProvider;

class STproductsearchproductsearchModuleFrontController extends ModuleFrontController
{
    public $php_self;
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:stproductsearch/views/templates/front/search.tpl');
    }
	...
	protected function getProducts()
    {
		...
		// {
			...
			$searchProvider = new STSearchProductSearchProvider(
				$this->context->getTranslator()				
			);
		// }
    ...
    {
        $entity = 'module-stproductsearch-'.$this->php_self;
