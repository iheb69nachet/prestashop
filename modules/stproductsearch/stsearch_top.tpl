...
<div id="_desktop_st_search_block_top" class="block exclusive st_search_block_top">
	...
	<form method="get" action="{$link->getPageLink('productsearch', true)|escape:'html':'UTF-8'}" id="stsearchtopbox">
		...
		<div class="block_content clearfix">
			...
			*}
			...
			<div class="list-cate-wrapper">
				<input id="stsearchtop-cate-id" name="cate" value="{if isset($selectedCate)}{$selectedCate}{/if}" type="hidden">
			...
			<input class="search_query form-control grey" type="text" id="st_search_query_top" name="search_query" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" placeholder="Search here..." />
			</div>
