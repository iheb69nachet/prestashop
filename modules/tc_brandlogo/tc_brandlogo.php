...
class Tc_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'tc_brandlogo';
        ...
        $this->templateFile = 'module:tc_brandlogo/views/templates/hook/tc_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('TC_BRAND_SLIDER', 1);
        Configuration::updateValue('TC_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('TC_BRAND_SLIDER')
            && Configuration::deleteByName('TC_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTcBlockBrandLogos')) {
            
			Configuration::updateValue('TC_BRAND_SLIDER', (int)(Tools::getValue('TC_BRAND_SLIDER')));
			Configuration::updateValue('TC_BRAND_NAME', (int)(Tools::getValue('TC_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitTcBlockBrandLogos';
    ...
    {
        return array(
            'TC_BRAND_SLIDER' => (int)Tools::getValue('TC_BRAND_SLIDER', Configuration::get('TC_BRAND_SLIDER')),
            'TC_BRAND_NAME' => (int)Tools::getValue('TC_BRAND_NAME', Configuration::get('TC_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('TC_BRAND_SLIDER'),
			'brandname' => Configuration::get('TC_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('tc_brandlogo');
