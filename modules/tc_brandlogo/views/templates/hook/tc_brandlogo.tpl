 ...
 <div class="container">
  <div class="product-carousel">
	<h2 class="h1 products-section-title text-uppercase">
		{if $display_link_brand}<a href="{$page_link}" title="{l s='Our Brands' mod='tc_brandlogo'}">{/if}
			{l s='Our Brands' d='Modules.Brandlist.Shop'}
	...
	<div class="products">
		...
		{else}
			<p>{l s='No brand' mod='tc_brandlogo'}</p>
		{/if}
	</div>
</section>
