...
include_once(_PS_MODULE_DIR_.'tc_leftbanner/LeftBanner.php');

class Tc_LeftBanner extends Module implements WidgetInterface
{
    protected $_html = '';
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->getTranslator()->trans('TC - Left Banner', array(), 'Modules.LeftBanner');
        ...
        $this->templateFile = 'module:tc_leftbanner/views/templates/hook/tcleftbanner.tpl';
    }
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            $slide['image_url'] = $this->context->link->getMediaLink(_MODULE_DIR_.'tc_leftbanner/views/img/'.$slide['image']);
        }
