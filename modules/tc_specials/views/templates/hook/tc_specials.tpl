 ...
 <div class="container">
  <div class="product-carousel">
	<h2 class="h1 products-section-title text-uppercase">
		{l s='Special Products' mod='tc_specials'}
	</h2>
	<div class="products">
		...
		<a class="all-product-link float-xs-right pull-md-right h4" href="{$allSpecialProductsLink}">
			{l s='View More Products' mod='tc_specials'}
		</a>
		{/if}
	  </div>
	</div>
