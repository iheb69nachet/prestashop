  ...
  <div class="thumbnail-container">
    ...
    {block name='product_thumbnail'}
      <a href="{$product.url}" class="thumbnail product-thumbnail">
		...
		<div class="product-actions">
			...
			<a href="{$product.url}" class="btn btn-primary view-button" title="{l s='View Detail' d='Shop.Theme.Actions'}">				
				{l s='View Detail' d='Shop.Theme.Actions'}
				<!--<span class="pst-product-view pst-product-tooltip">{l s='View Detail' d='Shop.Theme.Actions'}</span>-->
			</a>
    ...
    <div class="product-description">
      ...
      {block name='product_name'}
        <h3 class="h3 product-title" itemprop="name"><a href="{$product.url}" title="{$product.name}" title="{$product.name}">{$product.name|truncate:25:'...'}</a></h3>
      {/block}
