...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6034fe7a33f869_01080110',
...
function content_6034fe7a33f869_01080110 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div id="psttestimonialcmsblock" class="testimonial-block parallax" data-source-url="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_url']->value, ENT_QUOTES, 'UTF-8');?>
/testimonial-bg.jpg">
    <div class="container">
...
/person1.jpg" width="100" height="100"></div>
                ...
                <li class="item">
                    <div class="item cms_face">
                        <div class="testmonial-image col-lg-3 col-md-6 col-sm-12 col-xs-12"><img alt="testmonial" title="testmonial" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_url']->value, ENT_QUOTES, 'UTF-8');?>
/person2.jpg" width="100" height="100"></div>
                        <div class="product_inner_cms col-lg-9 col-md-6 col-sm-12 col-xs-12">
                            <div class="test-author">
                ...
                <li class="item">
                    <div class="item cms_face">
                        <div class="testmonial-image col-lg-3 col-md-6 col-sm-12 col-xs-12"><img alt="testmonial" title="testmonial" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_url']->value, ENT_QUOTES, 'UTF-8');?>
/person3.jpg" width="100" height="100"></div>
                        <div class="product_inner_cms col-lg-9 col-md-6 col-sm-12 col-xs-12">
                            <div class="test-author">
